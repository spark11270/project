...
import { fetchOrganic } from 'src/app/lib/data';
import { formatDateToLocal } from 'src/app/lib/utils';

export default async function OrganicTable() {
  const organic = await fetchOrganic();
            ...
            return (
              ...
              >
                ...
                <div className="text-right">
                  ...
                  >
                    Expires {formatDateToLocal(o.pexpiry)}
                  </p>
                </div>
              </div>
            );
